...
public class NewCard {
	...
	public NewCard(String firstName,String lastName,String fatherName,String motherName,String gender,String email,int age,String phoneNumber,String alternateNumber,String houseNumber,String streetName,String area,String pincode,String nationality,String state,String houseNumberP,String stateP,String areaP,String streetNameP,String pincodeP,String nationalityP,String doctype,String filename) {
...
//getters and setters
	...
	public String toString() {
		return "CardCorrection [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email
				...
				+ nationalityp + ", doctype=" + doctype + ", filename=" + filename + "]";
	}
